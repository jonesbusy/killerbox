...
public class FenetreCreationCompte extends FenetreBase 
{
	...
	FenetreCreationCompte(int hauteur, int largeur) 
	{
        ...
        FenetrePrincipale.addLabelTextRows(labels, textFields, gridbag, textControlsPane);
